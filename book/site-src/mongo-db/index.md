...
* [Practice Collections and Data](practice-collections-data.js)
* [Queries](queries.js)
...
* [MongoDB with Core Java](mongo-db-core-java/index.md)
* [Execte JS file from MongoSh](execute-js-file.md)
---
...
- [mongo-db-core-java](_code/mongo-db-core-java/index.md)
