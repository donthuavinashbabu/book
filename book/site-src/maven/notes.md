...
* Maven simplifies
	...
	* Mailing list
* Maven Overview\
![picture](img/maven-overview.png)
* POM
...
![picture](img/groupId_artifactId_version.jpg)
* Default values in pom\
![picture](img/default_values_in_pom.jpg)
* goal or task
...
![picture](img/adding_external_dependencies.jpg)
* Archetype
...
![picture](img/maven-multi-module.jpg)