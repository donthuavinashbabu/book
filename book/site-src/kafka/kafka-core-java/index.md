...
- [src/main/java/com/kafka/AdminClientTest.java](../_code/kafka-core-java/files/src/main/java/com/kafka/AdminClientTest.java.md): Contains test methods for creating and deleting Kafka topics using the Kafka Admin Client API.
- [src/main/java/com/kafka/ProducerTest.java](../_code/kafka-core-java/files/src/main/java/com/kafka/ProducerTest.java.md): Demonstrates Kafka producer functionality, including sending messages with and without keys.
- [src/main/java/com/kafka/ConsumerTest.java](../_code/kafka-core-java/files/src/main/java/com/kafka/ConsumerTest.java.md): Shows how to set up and use a Kafka consumer to consume messages from a Kafka topic.
- [src/main/java/com/kafka/MultipleConsumersByPartitionTest.java](../_code/kafka-core-java/files/src/main/java/com/kafka/MultipleConsumersByPartitionTest.java.md): In a group consumers consume from exclusive partitions of one topic 
- [pom.xml](../_code/kafka-core-java/files/pom.xml.md): Maven project configuration file specifying dependencies and build settings.
- [Dockerfile](../_code/kafka-core-java/files/Dockerfile.md): Defines the Docker image for the application using OpenJDK 17.
