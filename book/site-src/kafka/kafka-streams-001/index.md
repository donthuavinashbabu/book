...
### Execution
* Open [Example1](../_code/kafka-streams-001/files/src/main/java/com/java/Example1.java.md)
* Execute method `main`
...
### Execution
* Open [Example2](../_code/kafka-streams-001/files/src/main/java/com/java/Example2.java.md)
* Execute method `main`
* Execute method `consumer`
* Execute method `producer`
------
...
### Execution
* Open [Example3](../_code/kafka-streams-001/files/src/main/java/com/java/Example3.java.md)
* Execute method `main`
* Execute method `consumer`
* Execute method `producer`
------
...
* Write new processor class - [Processor1](../_code/kafka-streams-001/files/src/main/java/com/java/Processor1.java.md)
* Write new processor class - [Processor2](../_code/kafka-streams-001/files/src/main/java/com/java/Processor2.java.md)
* Write new processor class - [Processor3](../_code/kafka-streams-001/files/src/main/java/com/java/Processor3.java.md)
* Build topology
```
...
### Execution
* Open [Example4](../_code/kafka-streams-001/files/src/main/java/com/java/Example4.java.md)
* Execute method `main`
* Execute method `consumer`
* Execute method `producer`
...
* Send message input topic - `user.topology.input.txt`
* Consumed by [Processor4](../_code/kafka-streams-001/files/src/main/java/com/java/Processor4.java.md) then to [Processor5](../_code/kafka-streams-001/files/src/main/java/com/java/Processor5.java.md) then to [Processor6](../_code/kafka-streams-001/files/src/main/java/com/java/Processor6.java.md) then to sink topic
* Print - `peek`
* send to output topic - `user.topology.output.txt`
* Write new processor class - [Processor4](../_code/kafka-streams-001/files/src/main/java/com/java/Processor4.java.md)
* Write new processor class - [Processor5](../_code/kafka-streams-001/files/src/main/java/com/java/Processor5.java.md)
* Write new processor class - [Processor6](../_code/kafka-streams-001/files/src/main/java/com/java/Processor6.java.md)
* Build topology
```
...
* Send user and color as input to input topic - Refer `producer` method in [FavouriteColor](../_code/kafka-streams-001/files/src/main/java/com/java/FavouriteColorTest.java.md)
* Refer streaming logic. `stream` method in [FavouriteColor](../_code/kafka-streams-001/files/src/main/java/com/java/FavouriteColorTest.java.md)

### Execution
* Open [FavouriteColor](../_code/kafka-streams-001/files/src/main/java/com/java/FavouriteColorTest.java.md)
* Execute method `main`
* Execute method `consumer`
* Execute method `producer`