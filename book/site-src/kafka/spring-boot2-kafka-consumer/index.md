...
* Dependencies - Refer [pom.xml](../_code/spring-boot2-kafka-consumer/files/pom.xml.md) or [build.gradle](../_code/spring-boot2-kafka-consumer/files/build.gradle.md)

## Properties
* Add kafka properties in [application.yml](../_code/spring-boot2-kafka-consumer/files/src/main/resources/application.yml.md)

## Run from IDE
* Import project into IDE as Maven or Gradle project
* Execute [App.java](../_code/spring-boot2-kafka-consumer/files/src/main/java/com/app/App.java.md)

## Steps
* Create [AppConfig.java](../_code/spring-boot2-kafka-consumer/files/src/main/java/com/app/config/AppConfig.java.md) class
	* Add `@EnableKafka` annotation at class level
* Create [KafkaConsumer.java](../_code/spring-boot2-kafka-consumer/files/src/main/java/com/app/component/KafkaConsumer.java.md) class
...
* Once message sent to kafka topic, our consumer receives the message
	* We can see log from `onMessage` method in [KafkaConsumer.java](../_code/spring-boot2-kafka-consumer/files/src/main/java/com/app/component/KafkaConsumer.java.md) class
