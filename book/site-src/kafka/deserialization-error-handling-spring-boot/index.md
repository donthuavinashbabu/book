...
## Steps
* Dependencies refer in [pom.xml](../_code/deserialization-error-handling-spring-boot/files/pom.xml.md) or [build.gradle](../_code/deserialization-error-handling-spring-boot/files/build.gradle.md)
* Add `avro-maven-plugin` plugin
* Generate pojo classes as per schema [user.avsc](../_code/deserialization-error-handling-spring-boot/files/src/main/resources/avro/user.avsc.md)
```
...
## Replicate issue:
* Comment [ConsumerComponent.java](../_code/deserialization-error-handling-spring-boot/files/src/main/java/com/app/kafka/ConsumerComponent.java.md) code
...
* Stop app
* Uncomment [ConsumerComponent.java](../_code/deserialization-error-handling-spring-boot/files/src/main/java/com/app/kafka/ConsumerComponent.java.md) code
* Start app using `avro` profiles
```
-Dspring.profiles.active=avro
```