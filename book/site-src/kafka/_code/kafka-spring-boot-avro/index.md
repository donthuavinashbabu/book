...
hide:
  - navigation
---
# Code Project: kafka-spring-boot-avro

Module: **kafka**
Path: `kafka/kafka-spring-boot-avro`
...
<li data-filter="files/kafka-spring-boot-avro.postman_collection.json"><a href="files/files/kafka-spring-boot-avro.postman_collection.json.md">files/kafka-spring-boot-avro.postman_collection.json</a></li>
...
<li data-filter="src/main/java/com/app/kafka/producercomponent.java"><a href="files/src/main/java/com/app/kafka/ProducerComponent.java.md">src/main/java/com/app/kafka/ProducerComponent.java</a></li>
