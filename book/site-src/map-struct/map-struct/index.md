...
[DateFormatTest.java](../_code/map-struct/files/src/main/java/com/java/date/format/DateFormatTest.java.md)
...
[StudentEntity.java](../_code/map-struct/files/src/main/java/com/java/date/format/StudentEntity.java.md)
Represents a student entity with name, course, and joining dates (Date and GregorianCalendar).

[StudentMapper.java](../_code/map-struct/files/src/main/java/com/java/date/format/StudentMapper.java.md)
...
[StudentModel.java](../_code/map-struct/files/src/main/java/com/java/date/format/StudentModel.java.md)
Represents a student's information with name, course, and joining dates as strings.

### Example001 Package

[Example001Test.java](../_code/map-struct/files/src/main/java/com/java/example001/Example001Test.java.md)
A test class that verifies the mapping between StudentEntity and StudentModel classes.

[StudentEntity.java](../_code/map-struct/files/src/main/java/com/java/example001/StudentEntity.java.md)
Represents a simple student entity with name and course.

[StudentMapper.java](../_code/map-struct/files/src/main/java/com/java/example001/StudentMapper.java.md)
A MapStruct mapper interface for converting between StudentEntity and StudentModel objects.

[StudentModel.java](../_code/map-struct/files/src/main/java/com/java/example001/StudentModel.java.md)
Represents a student with name and course, used as a data model or transfer object.

### Other Files

[pom.xml](../_code/map-struct/files/pom.xml.md)
