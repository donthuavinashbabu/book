...
Source: `aws/s3/s3/src/test/java/com/s3/S3Practice.java`
...
public class S3Practice {
	...
	public void uploadObjectToBucket() {
		...
		String bucketName = "xitara-mytdp-test";
		String fileName = "C:\\MyPC\\one-place\\images\\1.jpeg";
		...
		PutObjectResult putObjectResult = s3Client.putObject(bucketName, "1", file);
	...
	public void downLoadObject() throws IOException {
		...
		String bucketName = "xitara-mytdp-test";
		String objectKey = "cWqBZvU9l_RUFcxpcUBF9";

		S3Object s3Object = s3Client.getObject(bucketName, objectKey);
		S3ObjectInputStream inputStream = s3Object.getObjectContent();
		FileUtils.copyInputStreamToFile(inputStream, new File("C:\\MyPC\\one-place\\images\\s3-downloads\\2.jpeg"));
	}
