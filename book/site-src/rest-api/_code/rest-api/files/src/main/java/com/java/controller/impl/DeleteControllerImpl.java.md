...
# DeleteControllerImpl.java

Source: `rest-api/rest-api/src/main/java/com/java/controller/impl/DeleteControllerImpl.java`

```java
package com.java.controller.impl;

import com.java.controller.DeleteController;
