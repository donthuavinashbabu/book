...
# PutControllerImpl.java

Source: `rest-api/rest-api/src/main/java/com/java/controller/impl/PutControllerImpl.java`

```java
package com.java.controller.impl;

import com.java.controller.PostController;
import com.java.controller.PutController;
...
@AllArgsConstructor
@RestController
public class PutControllerImpl implements PutController {
