...
# MySQLHikariCPTest.java

Source: `hikari-cp/hikari-cp/src/main/java/com/mysql/MySQLHikariCPTest.java`
...
@Slf4j
public class MySQLHikariCPTest {
     ...
     * mysql-connection-pool - Starting...
     * Loaded driver with class name com.mysql.cj.jdbc.Driver for jdbcUrl=jdbc:mysql://localhost:3306/practice?useSSL=false&verifyServerCertificate=false&noAccessToProcedureBodies=true
     * mysql-connection-pool - Added connection com.mysql.cj.jdbc.ConnectionImpl@6e20b53a
     * mysql-connection-pool - Start completed.
     * -- listing properties --
