...
- [StudentModel.java](../_code/core-java/files/src/main/java/com/serialization/StudentModel.java.md): Defines a serializable class with custom serialization methods.
- [SerializationTest.java](../_code/core-java/files/src/main/java/com/serialization/SerializationTest.java.md): Demonstrates the serialization and deserialization of objects.
