...
* [StringTest Examples](_code/core-java/files/src/main/java/com/practice/java/lang/StringTest.java.md)
...
* Refer array examples - [java.util.Arrays](_code/core-java/files/src/main/java/com/practice/java/util/ArraysTest.java.md)
	* parallelSort
	* parallelSetAll
	* setAll
	* parallelPrefix
