...
# DecimalFormatPracticeTest.java

Source: `core-java/core-java/src/main/java/com/practice/java/text/DecimalFormatPracticeTest.java`

```java
package com.practice.java.text;
