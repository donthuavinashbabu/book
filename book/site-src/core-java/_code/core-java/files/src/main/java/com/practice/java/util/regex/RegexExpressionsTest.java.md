...
# RegexExpressionsTest.java

Source: `core-java/core-java/src/main/java/com/practice/java/util/regex/RegexExpressionsTest.java`

```java
package com.practice.java.util.regex;
